import 'package:lean_streak/features/profile/data/models/user_profile.dart';
...
class HealthCalculator {
  ...
  ///
  /// - Slow     → 0.50 kg/week (safe)
  /// - Moderate → 0.75 kg/week (safe)
  /// - Fast     → 1.00 kg/week (caution)
  ...
  /// Calculates daily calorie target from a fixed weekly pace.
  ///
  /// 1 kg fat ≈ 7700 kcal → weekly deficit = pace × 7700
  /// daily deficit = weekly / 7 = pace × 1100
